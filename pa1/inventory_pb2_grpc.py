...
class InventoryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessOrder = channel.unary_unary(
                '/pa1.Inventory/ProcessOrder',
                request_serializer=inventory__pb2.OrderRequest.SerializeToString,
                response_deserializer=inventory__pb2.OrderReply.FromString,
...
def add_InventoryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=inventory__pb2.OrderReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'pa1.Inventory', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pa1.Inventory', rpc_method_handlers)
...
class Inventory(object):
    ...
    def ProcessOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            inventory__pb2.OrderReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
